...
Class Database extends PDO
{
  ...
  //データ挿入
  public function insertData($tbName, $name, $password)
  {
    do
    {
    ...
    $sql = "INSERT INTO $tbName(id, name, password, entryTime) VALUES(:id, :name, :password, :entryTime)";
  ...
  {
    $sql = "SELECT name, entryTime FROM $tbName ORDER BY entryTime ASC";
    // $sql = "SELECT * FROM $tbName ORDER BY entryTime ASC";
    $result = $this->query($sql);
    echo '<table border = "0" cellpadding="10" cellspacing="0">'. "\n";
    echo '<tr>'. "\n";
    echo '<th>番号</th><th>名前</th><th>登録日時</th>'. "\n";
    // echo '<tr><th>番号</th><th>ID</th><th>名前</th><th>PW</th><th>登録日時</th></tr>'. "\n";
    echo '</tr>'. "\n";
